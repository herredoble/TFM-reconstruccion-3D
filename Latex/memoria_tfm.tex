...
\begin{figure}[H]
  ...
  \begin{subfigure}[b]{\linewidth}
    ...
    \caption{Pipeline completo desde im\'agenes: cinco fotograf\'ias de una
             taza rota pasan por E1 (segmentaci\'on de fondo), E2 (Pix2Vox++),
             E3 (PoinTr) y E4 (Poisson) hasta generar el STL descargable.}
  ...
  \begin{subfigure}[b]{\linewidth}
    ...
    \caption{Modo desde \texttt{.npy}: nube de puntos rota pre-extra\'ida enviada
             directamente a E3 (PoinTr) y E4 (Poisson + STL), omitiendo E1 y E2.}
    \label{fig:app_rebuild3d_npy}
  \end{subfigure}

  \caption{Interfaz de REBUILD3D\@. Cada vista 3D es interactiva y el layout
           es configurable (apilado o lado a lado mediante un selector).
           El archivo STL es descargable directamente desde la interfaz.}
